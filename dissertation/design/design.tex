...
Proquest provides access to many different databases containing licenced scholarly journals, newspapers, wire feeds, reports, etc. Using a trinity account, access is allowed 30 of these databases. Some of the databases included are:
\begin{itemize}
...
\begin{itemize}
    \item \texttt{Return Vs Sentiment Grapher} -- Allows the graphing of sentiment keys and price keys in a timeseries
...
One more component was made to be used as a predecessor for some of these components, depending on the data that is desired to be analysed. It will be referred to as the Joiner. It's purpose is to join the sentiment and prices datasets where they overlap.
